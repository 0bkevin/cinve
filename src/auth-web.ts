export function loginPage() {
  return `<!doctype html><html lang="es"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Conectar cuentas · Cinev</title>
<style>
...
</style><main><header><span class="brand">cinev<span style="color:#6e9169">.</span></span><span class="local">Conexión privada</span></header>
